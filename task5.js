...
// All salaries > 20000
let above20k = employees.every(emp => emp.salary > 20000)
console.log("All salaries > 20000:", above20k)
...
console.log("First 6 characters:", clean.slice(0,6))
...
// football and tennis
let s1 = sports.slice(1,3)
console.log(s1)

// first 3 sports
let s2 = sports.slice(0,3)
console.log(s2)